...
public class Nomad implements ModInitializer {
  ...
  public static final NomadServer NOMAD_SERVER = new NomadServer(
  ...
  public static final NomadClient NOMAD_CLIENT = new NomadClient(
      FabricBlockSettings.of(Material.METAL).hardness(4.0f).nonOpaque());
  ...
  public static final NomadWires NOMAD_WIRES = new NomadWires(
      FabricBlockSettings.of(Material.GLASS).hardness(4.0f).nonOpaque());
  ...
  public static final NomadAlloc NOMAD_ALLOC = new NomadAlloc(
      FabricBlockSettings.of(Material.GLASS).nonOpaque().breakInstantly().dropsNothing());
  ...
  public void onInitialize() {
    ...
    if (root.exists()) {
      ...
      for (File f : files) {
        if (f.getName().endsWith(".json")) {
          ...
          Registry.register(Registry.ITEM, identifier("nomad_job_" + name),
              new NomadJob(new Item.Settings().group(ITEM_GROUP), name));
        }
      }
    }

    Registry.register(Registry.BLOCK, NOMAD_SERVER_ID, NOMAD_SERVER);
    Registry.register(Registry.ITEM, NOMAD_SERVER_ID,
        new BlockItem(NOMAD_SERVER, new Item.Settings().group(ITEM_GROUP)));
    NOMAD_SERVER_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, NOMAD_SERVER_ID,
        FabricBlockEntityTypeBuilder.create(NomadServerEntity::new, NOMAD_SERVER).build(null));

    Registry.register(Registry.BLOCK, NOMAD_CLIENT_ID, NOMAD_CLIENT);
    Registry.register(Registry.ITEM, NOMAD_CLIENT_ID,
        new BlockItem(NOMAD_CLIENT, new Item.Settings().group(ITEM_GROUP)));
    NOMAD_CLIENT_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, NOMAD_CLIENT_ID,
        FabricBlockEntityTypeBuilder.create(NomadClientEntity::new, NOMAD_CLIENT).build(null));
    ...
    NOMAD_WIRES_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, NOMAD_WIRES_ID,
        FabricBlockEntityTypeBuilder.create(NomadWiresEntity::new, NOMAD_WIRES).build(null));
    ...
    NOMAD_ALLOC_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, NOMAD_ALLOC_ID,
        FabricBlockEntityTypeBuilder.create(NomadAllocEntity::new, NOMAD_ALLOC).build(null));
    ...
    ServerLifecycleEvents.SERVER_STARTED.register((MinecraftServer server) -> {
      ...
      NomadServerState.RegisterStateUpdates(server);
    });
